...
export default function Home() {
  return( <main>
    ...
    !overflow-visible relative flex flex-col items-center antialiased">
      <div className="absolute inset-0 h-full items-center px-5 py-24
       [background:radial-gradient(125%_125%_at_50%_10%, #000_35%,#223_100%"></div>
       <div className="flex flex-xol mt-[-100px] md:mt-[-50px]">
        <ContainerScroll
         titleComponent = {
          <div className="flex items-center justify-center flex-col">
            <Button size={'lg'}
            classNmae="p-8 mb-0 text-2xl w-full sm:w-fit border-t-2
